...
import com.greencode.GreenMarket.services.microservices.ProductsService;
...
public class CartLoggingAspect {
    ...
    public void loggingBeforeAddToCart(JoinPoint joinPoint){
        ...
        Log4jUtil.log.info("The user is trying to add a product: " + product.getTitle() + " with id: " + product.getId() + "  to a cart ");
    }
    ...
    public void loggingAfterAddToCart(JoinPoint joinPoint){
        ...
        Long productId = (Long) args[1];
        Product product = productsService.getOneById(productId);
        Log4jUtil.log.info("The user added the product: " + product.getTitle() + " with id: " + product.getId() + "  to the cart ");
    }
    ...
    public void loggingBeforeDeleteOneInCart(JoinPoint joinPoint){
        ...
        Long productId = (Long) args[1];
        Product product = productsService.getOneById(productId);
        Log4jUtil.log.info("The user is trying to delete the product: " + product.getTitle() + " with id: " + product.getId() + "  from the cart ");
    }
    ...
    public void loggingAfterDeleteOneInCart(JoinPoint joinPoint){
        ...
        Long productId = (Long) args[1];
        Product product = productsService.getOneById(productId);
        Log4jUtil.log.info("The user has deleted the product: " + product.getTitle() + " with id: " + product.getId() + "  from the cart ");
    }
}
